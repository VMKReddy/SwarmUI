...
void setMotor1(int8_t speed)
{
    ...
    __HAL_TIM_SET_COMPARE(&motorsTimHandle, MOTOR1_CHANNEL, motor1);
    __HAL_TIM_SET_COMPARE(&motorsTimHandle, MOTOR2_CHANNEL, motor2);
}
...
void setMotor2(int8_t speed)
{
    ...
    __HAL_TIM_SET_COMPARE(&motorsTimHandle, MOTOR3_CHANNEL, motor3);
    __HAL_TIM_SET_COMPARE(&motorsTimHandle, MOTOR4_CHANNEL, motor4);
}
